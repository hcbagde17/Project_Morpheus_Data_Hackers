...
// --- User32 Functions ---
const SetWindowsHookExA = user32.func('SetWindowsHookExA', HHOOK, ['int', koffi.pointer(koffi.func('HookCallback', 'intptr', ['int', 'intptr', koffi.pointer(KBDLLHOOKSTRUCT)])), HINSTANCE, 'uint32']);
